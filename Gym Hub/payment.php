...
// Plan details
$plans = array(
    'platinum' => 'Platinum Plan - $36.99 per month',
    'national' => 'National Plan - $31.99 per month',
    'silver' => 'Silver Plan - $14.99 per month'
);

$selected_plan = isset($plans[$plan]) ? $plans[$plan] : 'Invalid Plan';
?>
...
<body>
    ...
    <div class="content">
        <div class="payment-card">
            <h3>Payment for <?php echo $selected_plan; ?></h3>
            <form action="process_payment.php" method="post">
                ...
                <div class="form-group">
                    <label for="cvv">Name on Card</label>
                    <input type="text" class="form-control" id="name_card" name="name_card" required>
                </div>
